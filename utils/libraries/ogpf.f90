...
module ogpf
    ...
    integer, parameter :: sp = kind( 1.0_psb_spk_ )
    integer, parameter :: dp = kind( 1.0_psb_dpk_ )
    ...
    type, public :: gpf
        ...
        ! Use a terminal setup by the user
        logical :: user_terminal        = .false.
        character(len=:), allocatable   :: terminalstring
    ...
    contains
        ...
        ! public procedures
        procedure, pass, public :: setterminal  => set_terminal
...
contains
    ...
    subroutine set_terminal(this, string)
        ...
        this%user_terminal = .true.
        this%terminalstring = trim(string)
    ...
    subroutine create_outputfile(this)
        ...
        if(this%user_terminal) then
            write(unit=this%file_unit, fmt='(a)') this%terminalstring
        else
